...
class Calculator:
    ...
    def create_equals_button(self):
        button = tk.Button(self.buttons_frame, text="=", bg=LIGHT_BROWN, fg=WHITE, font=DEFAULT_FONT_STYLE,
